 ...
 */
import { PagedModelEntityModelUserDto } from './pagedModelEntityModelUserDto';


export interface ApiResponsePagedModelEntityModelUserDto { 
    message?: string;
    status?: ApiResponsePagedModelEntityModelUserDto.StatusEnum;
    data?: PagedModelEntityModelUserDto;
}
export namespace ApiResponsePagedModelEntityModelUserDto {
