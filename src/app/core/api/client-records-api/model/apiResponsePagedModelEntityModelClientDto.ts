 ...
 */
import { PagedModelEntityModelClientDto } from './pagedModelEntityModelClientDto';


export interface ApiResponsePagedModelEntityModelClientDto { 
    message?: string;
    status?: ApiResponsePagedModelEntityModelClientDto.StatusEnum;
    data?: PagedModelEntityModelClientDto;
}
export namespace ApiResponsePagedModelEntityModelClientDto {
